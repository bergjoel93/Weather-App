...
function _getCurrentWeather() {
  _getCurrentWeather = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(location) {
    var apiKey, url, response, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          apiKey = "aa1328b351db477fb30205829240905";
          url = "http://api.weatherapi.com/v1/current.json?key=".concat(apiKey, "&q=").concat(location);
          _context.prev = 2;
          _context.next = 5;
          return fetch(url);
        case 5:
...
console.log(getCurrentWeather("salt lake city"));
})();
