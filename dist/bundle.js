...
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100..900;1,100..900&family=Poetsen+One&display=swap);"]);
// Module
...
@media (max-width: 500px) {
  .panel-2 {
    grid-template-columns: repeat(2, 1fr); /* For narrow screens: 2 columns */
    grid-template-rows: repeat(4, 1fr); /* For narrow screens: 4 rows */
  }
  .current-temperature {
    font-size: 2rem;
  }
...
#high-low-title > :first-child {
  border-right: solid #ffff 1px;
}
...
`, "",{"version":3,"sources":["webpack://./src/styles/style.css"],"names":[],"mappings":"AACA;EACE,SAAS;EACT,UAAU;EACV,sBAAsB;AACxB;;AAEA;EACE;;IAEE,YAAY;EACd;AACF;;AAEA;;EAEE,kBAAkB;AACpB;;AAEA;EACE,YAAY;EACZ,YAAY;EACZ,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,mBAAmB;EACnB,4BAA4B;EAC5B,sBAAsB;EACtB,qCAAqC;AACvC;;AAEA;EACE,WAAW;EACX,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,YAAY;EACZ,sCAAsC;AACxC;;AAEA;EACE,OAAO;EACP,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,YAAY;EACZ,UAAU;AACZ;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,6BAA6B;EAC7B,mBAAmB;EACnB,kBAAkB;EAClB,WAAW;AACb;AACA;EACE,YAAY;AACd;;AAEA;EACE,YAAY;EACZ,oCAAoC;EACpC,kBAAkB;EAClB,YAAY;EACZ,UAAU;EACV,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,QAAQ;AACV;;AAEA;EACE,eAAe;EACf,aAAa;EACb,mBAAmB;EACnB,uBAAuB;AACzB;;AAEA;EACE,aAAa;EACb,sCAAsC;EACtC,2BAA2B;EAC3B,QAAQ;AACV;;AAEA;EACE;IACE,qCAAqC,EAAE,kCAAkC;IACzE,kCAAkC,EAAE,+BAA+B;EACrE;EACA;IACE,eAAe;EACjB;AACF;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,uBAAuB;EACvB,kBAAkB;EAClB,oCAAoC;EACpC,aAAa;EACb,2BAA2B;AAC7B;AACA;EACE,aAAa;EACb,uBAAuB;EACvB,gBAAgB;EAChB,iBAAiB;AACnB;AACA;EACE,WAAW;EACX,aAAa;EACb,6BAA6B;EAC7B,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB,uBAAuB;AACzB;;AAEA;EACE,6BAA6B;AAC/B;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB,uBAAuB;AACzB;;AAEA;;EAEE,eAAe;AACjB;AACA;EACE,6BAA6B;AAC/B;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,iBAAiB;EACjB,iBAAiB;AACnB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,YAAY;EACZ,eAAe;EACf,aAAa;EACb,iBAAiB;EACjB,oBAAoB;AACtB","sourcesContent":["@import url(\"https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100..900;1,100..900&family=Poetsen+One&display=swap\");\n* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\n@media (min-width: 500px) {\n  html,\n  body {\n    height: 100%;\n  }\n}\n\nhtml,\nbody {\n  overflow-x: hidden;\n}\n\nbody {\n  width: 100vw;\n  height: auto;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  background-repeat: no-repeat;\n  background-size: cover;\n  font-family: \"Montserrat\", sans-serif;\n}\n\nheader {\n  width: 100%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  margin: 1rem;\n  font-family: \"Poetsen One\", sans-serif;\n}\n\nmain {\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin: 16px;\n  width: 80%;\n}\n\n.current {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-evenly;\n  align-items: center;\n  text-align: center;\n  width: 100%;\n}\n.location {\n  margin: 1rem;\n}\n\ninput {\n  margin: 1rem;\n  background-color: rgba(0, 0, 0, 0.5);\n  border-style: none;\n  padding: 8px;\n  width: 80%;\n  border-radius: 5px;\n}\n\n.panel-1 {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: 8px;\n}\n\n.current-temperature {\n  font-size: 3rem;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.panel-2 {\n  display: grid;\n  grid-template-columns: 1fr 1fr 1fr 1fr;\n  grid-template-rows: 1fr 1fr;\n  gap: 8px;\n}\n\n@media (max-width: 500px) {\n  .panel-2 {\n    grid-template-columns: repeat(2, 1fr); /* For narrow screens: 2 columns */\n    grid-template-rows: repeat(4, 1fr); /* For narrow screens: 4 rows */\n  }\n  .current-temperature {\n    font-size: 2rem;\n  }\n}\n\n.card {\n  width: 110px;\n  height: 110px;\n  border: solid black 1px;\n  border-radius: 8px;\n  background-color: rgba(0, 0, 0, 0.3);\n  display: grid;\n  grid-template-rows: 1fr 1fr;\n}\n.card-title {\n  display: flex;\n  justify-content: center;\n  align-items: end;\n  font-size: 1.5rem;\n}\n.threeDay {\n  width: 100%;\n  display: flex;\n  justify-content: space-around;\n  margin-top: 16px;\n}\n\n#high-low-title {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  align-items: center;\n  justify-content: center;\n}\n\n#high-low-title > :first-child {\n  border-right: solid #ffff 1px;\n}\n\n.high-low {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  align-items: center;\n  justify-content: center;\n}\n\n#high,\n#low {\n  font-size: 12px;\n}\n#high {\n  border-right: solid #ffff 1px;\n}\n\n.material-symbols-outlined {\n  font-size: 2.4rem;\n}\n\n.card > :last-child {\n  align-self: start;\n  font-size: 1.3rem;\n}\n\n#feels-like-title {\n  font-size: 1.2rem;\n}\n\n.sub-title {\n  height: 100%;\n  font-size: 25px;\n  display: flex;\n  padding-top: 12px;\n  font-weight: lighter;\n}\n"],"sourceRoot":""}]);
// Exports
...
function defaultState() {
  return _defaultState.apply(this, arguments);
}
function _defaultState() {
  _defaultState = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return getWeatherData("Salt lake City");
        case 2:
          data = _context2.sent;
          if (data) {
            render(data);
...
function render(data) {
  ...
  var locationString = "".concat(data.location, ", ").concat(data.region, ", ").concat(data.country);
  location.innerHTML = locationString;
  // todays date
  var date = document.querySelector(".current-date");
  date.innerHTML = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.parseISO)(data.date), "MMMM d yyyy");
  // Conditions
  var currentCondition = document.querySelector(".current-condition");
  currentCondition.innerHTML = "".concat(data.condition);
  // current temp
  var currentTemp = document.querySelector("#current-temperature");
  currentTemp.innerHTML = "".concat(data.temperatureF, "\xB0 F");

  // icon
  var icon = document.querySelector("#weather-icon");
  icon.src = "".concat(data.icon);
  ...
  windDirection.innerHTML = "".concat(data.windDir);
  var windSpeed = document.querySelector("#wind-speed");
  windSpeed.innerHTML = "".concat(data.windSpeed, " mph");

  // uv index
  var uv = document.querySelector("#uv");
  uv.innerHTML = "".concat(data.uv);

  // air quality
  var aqiCard = document.querySelector("#aqi-card");
  var epaIndex = Number(data.aqi);
  changeAqiCardColor(epaIndex, aqiCard);
  var aqi = document.querySelector("#aqi");
  aqi.innerHTML = "".concat(data.pm25);

  // feels like
  var feelsLike = document.querySelector("#feelsLike");
  feelsLike.innerHTML = "".concat(data.feelsLike, "\xB0 F");

  // high and low
  var high = document.querySelector("#high");
  var low = document.querySelector("#low");
  high.innerHTML = "".concat(data.high, "\xB0 F");
  low.innerHTML = "".concat(data.low, "\xB0 F");

  // rain chance
  var rain = document.querySelector("#rain");
  rain.innerHTML = "".concat(data.chanceRain, " %");

  // sunrise
  var sunrise = document.querySelector("#sunrise");
  sunrise.innerHTML = "".concat(data.sunrise);

  //sunset
  var sunset = document.querySelector("#sunset");
  sunset.innerHTML = "".concat(data.sunset);
  ...
  day1Icon.src = "".concat(data.day1Icon);
  day1low.innerHTML = "".concat(data.low1, "\xB0 F");
  day1high.innerHTML = "".concat(data.high1, "\xB0 F");
  ...
  day2Icon.src = "".concat(data.day2Icon);
  day2low.innerHTML = "".concat(data.low2, "\xB0 F");
  day2high.innerHTML = "".concat(data.high2, "\xB0 F");
  ...
  day3Icon.src = "".concat(data.day3Icon);
  day3low.innerHTML = "".concat(data.low3, "\xB0 F");
  day3high.innerHTML = "".concat(data.high3, "\xB0 F");
}
function changeAqiCardColor(epaIndex, aqiCard) {
  var alpha = 0.3;
  switch (epaIndex) {
    case 1:
      aqiCard.style.backgroundColor = "rgba(4,225,14,".concat(alpha, ")");
      break;
    case 2:
      aqiCard.style.backgroundColor = "rgba(253,249,3,".concat(alpha, ")");
      break;
    case 3:
      aqiCard.style.backgroundColor = "rgba(253,124,0,".concat(alpha, ")");
      break;
    case 4:
      aqiCard.style.backgroundColor = "rgba(249,87,58,".concat(alpha, ")");
      break;
    case 5:
      aqiCard.style.backgroundColor = "rgba(177,69,111,".concat(alpha, ")");
      break;
    case 6:
      aqiCard.style.backgroundColor = "rgba(120,12,27,".concat(alpha, ")");
      break;
    default:
...
function _getWeatherData() {
  _getWeatherData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(location) {
    var weekday, data, weatherData;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          weekday = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
          _context3.next = 3;
          return getCurrentWeatherJSON(location);
        case 3:
          data = _context3.sent;
        ...
        case 9:
          ...
          weatherData = {
            ...
            date1: (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.parseISO)(data.forecast.forecastday[0].date), "EEEE"),
            ...
            date2: (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.parseISO)(data.forecast.forecastday[1].date), "EEEE"),
            ...
            date3: (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.parseISO)(data.forecast.forecastday[2].date), "EEEE"),
...
function getCurrentWeatherJSON(_x2) {
  return _getCurrentWeatherJSON.apply(this, arguments);
}
/**
 * This function changes the background of the app to match the current conditions of the day.
 */
function _getCurrentWeatherJSON() {
  _getCurrentWeatherJSON = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(location) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 12:
          ...
          console.error("Error fetching weather data:", _context4.t0);
